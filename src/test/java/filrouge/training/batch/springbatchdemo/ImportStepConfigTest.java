...
import filrouge.training.batch.springbatchdemo.config.ImportJobConfig;
...
import filrouge.training.batch.springbatchdemo.config.JobCompletionNotificationListener;

@RunWith(SpringRunner.class)
@SpringBootTest
@ContextConfiguration(classes = { /* BatchApplication.class, */ BatchTestConfiguration.class,
        ImportJobConfig.class, JobCompletionNotificationListener.class})
 ...
 //   private JobRepositoryTestUtils jobRepositoryTestUtils;
    ...
    public void importJob() throws Exception {
        ...
        final JobParameters jobParameters = new JobParametersBuilder(testUtils.getUniqueJobParameters()) //
                .addString("input-file", "src/main/resources/input-data.csv") //
                .toJobParameters();
        // When
    ...
    public void importStepWithFileShouldSuccess() {
        ...
        final JobParameters jobParameters = new JobParametersBuilder(testUtils.getUniqueJobParameters()) //
                ...
                //    .addString("input-file", "src/main/resources/data.sql") //
                .toJobParameters();
        // When
        final JobExecution jobExec = testUtils.launchStep("import-step", jobParameters);
        // Then
        assertThat(jobExec.getStatus(), equalTo(BatchStatus.COMPLETED));
        assertThat(countRowsInTable(jdbcTemplate, "book"), equalTo(10));
    }
